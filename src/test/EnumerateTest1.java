...
// enumerate nodal degrees of freedom
		n1.enumerateDOFs(eqn);
		n2.enumerateDOFs(eqn);
...
//		System . out . println (" Number of equation : " + eqn );
		...
		System . out . println ( ArrayFormat . format (n1.getDOFNumb()));
		System . out . println ( ArrayFormat . format (n2.getDOFNumb()));
		System . out . println (" Equation numbers of element DOFs " );
		System . out . println ( ArrayFormat . format (e1.getDOFNumb()));
	}
}