...
public class ThermoMechanicalCouplingTest {
    ...
    public static Structure createStructure() {
        ...
        Force f = new Force(0, -20e2, -100);  // Mechanical force on node 1
        ...
        struct.getElement(0).setThermalFlux(-2);  // Element 0 has a thermal flux of 3 W/m^2
        struct.getElement(2).setThermalFlux(-2);  // Element 2 has a thermal flux of 5 W/m^2
        struct.getElement(4).setThermalFlux(2);  // Element 4 has a thermal flux of 3 W/m^2
    ...
    public static void main(String[] args) {
        ...
        // DEBUG: Now solve the thermo-mechanical coupled problem
        System.out.println("\n=== Solving Coupled Thermo-Mechanical Problem ===");
        try {
            struct.solveCoupledSystem();
        } catch (Exception e) {
            System.out.println("Error during thermo-mechanical solve: " + e.getMessage());
            e.printStackTrace();
        }
